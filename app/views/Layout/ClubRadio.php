...
<section id="clubradio" class="clubRadio-section club-section section-animation delay-1">
            ...
            <div id="modalClubRadio" class="modal">
                <div class="modal-content">
                    ...
                    <form id="ClubRadioForm" action="<?php echo BURL; ?>Request/registre/3" method="POST">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gestion_projet" value="gestion_projet"
                                name="competences[]">
    ...
    <div class="fondation">
        ...
        <p>
            À l’origine du Club Radio ESSECT FM
            Les initiateurs qui ont donné vie au club

            Tout a commencé le 13 décembre 2024, lorsque l'idée de créer un club radio a émergé, portée par la passion
            et la volonté de donner une voix aux étudiants.

            Après plusieurs semaines de travail et de préparation, ce projet ambitieux a pris vie officiellement le 6
            février 2025.
            Les initiateurs qui ont donné vie au club

            Grâce à l’initiative et à l’engagement de ses fondateurs, Oucema Abdelkrim, Mohamed Ali Adouni et Elyes
            Hachicha, ESSECT FM est devenu un espace de créativité, d’expression et de partage, où chaque membre peut
            contribuer à faire vibrer les ondes !
    ...
    <div class="our-mission">
        <h3>our-mission</h3>
        <p>La mission de la « Radio ESSECT FM » est de favoriser la
            communication, l’échange et le divertissement entre
            étudiants, enseignants et personnel administratif, en
            offrant une plateforme d’information, de culture et de
            détente. Elle vise à enrichir la vie universitaire, renforcer
            le lien communautaire et dynamiser l'engagement au</p>
    </div>
